class Promptwatch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/thieso2/promptwatch/releases/download/v0.1/promptwatch-darwin-arm64-v0.1.tar.gz"
      sha256 "68d2a2d9e309763563154f816e5112046ac06e960e3a4ee46addd51cc965e550"
    end
    on_intel do
      url "https://github.com/thieso2/promptwatch/releases/download/v0.1/promptwatch-darwin-amd64-v0.1.tar.gz"
