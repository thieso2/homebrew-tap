class Promptwatch < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/thieso2/promptwatch/releases/download/v0.1.0/promptwatch-darwin-arm64-v0.1.0.tar.gz"
      sha256 "2b81abf491576e5e4c3586fa57257dd11e3460ded0aa5ecb9c85862c4f99b600"
    end
    on_intel do
      url "https://github.com/thieso2/promptwatch/releases/download/v0.1.0/promptwatch-darwin-amd64-v0.1.0.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/thieso2/promptwatch/releases/download/v0.1.0/promptwatch-linux-arm64-v0.1.0.tar.gz"
      sha256 "c8e0a4ef04999a5863fbc38a3212a5388c7c8ac643aac0ca8a4bfb93aad1cf9f"
    end
    on_intel do
      url "https://github.com/thieso2/promptwatch/releases/download/v0.1.0/promptwatch-linux-amd64-v0.1.0.tar.gz"
